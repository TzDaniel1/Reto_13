    ...
    for i in range(8):
        ...
        for alerta in alertas:
            if data[alerta][str(i)] == "X":
                # Imprime el tipo de alerta y los parámetros relevantes
...
# Ejecuta la función para revisar alertas
...
def get_json_and_print_pairs(api_url):
    ...
    if response.status_code == 200:
        ...
        print(json_data)  # Imprimir JSON completo
        print("\nPares clave: valor")
...
# Conecta a cada API y muestra los datos
for url in api_urls:
